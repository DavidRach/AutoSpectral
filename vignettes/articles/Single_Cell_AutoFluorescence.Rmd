...
nodes because this gives slightly inferior results in the unmixing.
...
FCS file into R, extracting the expression data and so on. The better option is to just call unmix.fcs directly, which will create an unmixed FCS file from your raw FCS file.
...
Alternatively, we can call `method = "Automatic"`, which is the default. This takes
