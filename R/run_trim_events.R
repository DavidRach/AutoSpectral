...
#' @param trim.sample.data A list containing the expression data for each sample.
#' @param trim.sample A character vector specifying the names of the samples.
#' @param trim.peak.channels A list containing the peak channels for each sample.
#' @param trim.factor A numeric value indicating the proportion of extreme events
#'     to trim from both ends of the peak channel distribution.
