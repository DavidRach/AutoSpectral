...
#'
#' @description This function runs the identification of autofluorescence artefacts
#'     on a list of negative samples, using the specified parameters and settings.
#'
...
#'
#' @return A list containing the identified autofluorescence artefacts for each negative sample.
#' @export
